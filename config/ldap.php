            ...
            */
            'settings' => [
                ...
                */
                ...
                |
                */
                'account_suffix' => env('LDAP_ACCOUNT_SUFFIX', '@ict.lab.locals'),
                /*
                |--------------------------------------------------------------------------
                | Domain Controllers
                |--------------------------------------------------------------------------
                ...
                |
                */
                'hosts' => explode(',', env('LDAP_HOSTS', 'dc1.ict.lab.locals,dc2.ict.lab.locals')),
                /*
                |--------------------------------------------------------------------------
                | Port
                |--------------------------------------------------------------------------
                ...
                */
                ...
                |
                */
                'base_dn' => env('LDAP_BASE_DN', 'DC=ict,DC=lab,DC=locals'),
                /*
                |--------------------------------------------------------------------------
